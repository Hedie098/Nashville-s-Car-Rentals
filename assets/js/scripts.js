...
(function($) {
    ...
    var initGoogleMap = function initGoogleMap(element) {
        var mapOptions = {
            ...
            center: new google.maps.LatLng(36.14420619173738, -86.74937280859466),
            // New York
        ...
        var marker = new google.maps.Marker({
            position: new google.maps.LatLng(36.14420619173738, -86.74937280859466),
            map: map,
            icon: icon,
            title: 'Snazzy!'
        });
        var infowindow = new google.maps.InfoWindow({
            content: '403 Murfreesboro Pike, Nashville<br />Tennessee – 37210, USA'
        });
